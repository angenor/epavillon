...
- Cop désertification
Contrairement à la Cop climat, les autres cop n'ont pas forcément droit à un stand puis défilé d'organisation. Parfois oui et parfois non

Le workflow simplifé se passe ainsi:
- l'OIF/IFDD lance un appel à proposition de projet,
- un organisations, pays, ong etc soumettent leurs propositions
- l'IFDD fait le trie et sélectionne les projets interressants
