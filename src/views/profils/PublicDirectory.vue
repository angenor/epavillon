<template>
  <div class="min-h-screen bg-gradient-to-br from-gray-50 via-gray-50 to-white dark:from-gray-900 dark:via-gray-900 dark:to-gray-800">
    <!-- Header Héro moderne -->
    <div class="relative bg-gradient-to-r from-ifdd-green-600 via-ifdd-green-700 to-ifdd-green-800 dark:from-ifdd-green-700 dark:via-ifdd-green-800 dark:to-ifdd-green-900 overflow-hidden">
      ...
      <div class="lg:grid lg:grid-cols-4 lg:gap-10">
        ...
        <div class="lg:col-span-3 mt-10 lg:mt-0">
          ...
          <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
              <div class="flex items-center space-x-3">
                <div class="flex items-center justify-center w-10 h-10 bg-ifdd-green-100 dark:bg-ifdd-green-900 rounded-lg">
                  <svg class="w-5 h-5 text-ifdd-green-600 dark:text-ifdd-green-400" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3z"/>
                  </svg>
                </div>
                <div>
              ...
              <div class="flex items-center space-x-4">
                ...
                <div class="relative">
                  <select
                    ...
                    class="appearance-none bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg pl-3 pr-10 py-2 text-sm text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-ifdd-green-500 focus:border-transparent"
                  >
                ...
                <div class="flex bg-gray-100 dark:bg-gray-700 rounded-lg p-1 shadow-inner">
                  <button
                    ...
                    :class="[
                      ...
                      viewMode === 'grid'
                        ? 'bg-white dark:bg-gray-600 text-ifdd-green-600 dark:text-ifdd-green-400 shadow-md scale-105'
          ...
          <div v-if="loading" class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-12">
            <div class="text-center">
              <div class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-ifdd-green-100 to-ifdd-green-200 dark:from-ifdd-green-900 dark:to-ifdd-green-800 rounded-full mb-4">
                <div class="animate-spin rounded-full h-8 w-8 border-b-2 border-ifdd-green-600"></div>
              </div>
          ...
          <div v-else-if="profiles.length === 0" class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-12">
            <div class="text-center">
              ...
              <button
                @click="resetFilters"
                class="mt-6 inline-flex items-center px-6 py-3 bg-ifdd-green-600 hover:bg-ifdd-green-700 text-white font-medium rounded-lg transition-colors duration-200"
              >
            ...
            <div class="flex items-center justify-between">
                ...
                <button
                  ...
                  :class="[
                    ...
                    pagination.currentPage === 1
                      ...
                      : 'bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600 hover:border-ifdd-green-300 hover:text-ifdd-green-600 transform hover:scale-105'
                  ]"
                >
                  <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <button
                      ...
                      :class="[
                        ...
                        page === pagination.currentPage
                          ? 'bg-gradient-to-r from-ifdd-green-500 to-ifdd-green-600 text-white shadow-lg scale-110'
                          : 'bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600 hover:border-ifdd-green-300 hover:text-ifdd-green-600 hover:scale-105'
                      ]"
                    >
                      {{ page }}
                    </button>
              ...
              <div class="flex items-center space-x-2">
                <button
                  ...
                  @click="changePage(1)"
                  class="text-sm text-gray-500 dark:text-gray-400 hover:text-ifdd-green-600 transition-colors duration-200"
                >
                  Première
                </button>
                <button
