<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    ...
    <div v-else-if="organization" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      <!-- Breadcrumbs -->
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 mb-8">
        <div class="p-6">
          <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between">
            <!-- Left side: Logo, name, and basic info -->
            <div class="flex-1">
              <div class="flex items-start space-x-6">
                ...
                <div class="flex-shrink-0">
                  <img
                    ...
                    class="h-24 w-24 rounded-lg object-cover border-2 border-gray-200 dark:border-gray-600"
                  />
                  <div
                    v-else
                    class="h-24 w-24 rounded-lg bg-gradient-to-r from-blue-500 to-purple-600 flex items-center justify-center"
                  >
                ...
                <div class="flex-1 min-w-0">
                  <div class="flex items-center mb-3">
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white mr-3">
                      {{ organization.name }}
                    </h1>
                  ...
                  <div class="flex flex-wrap items-center gap-4 mb-4">
                    <div class="flex items-center text-sm text-gray-600 dark:text-gray-400">
                      <OrganizationTypeIcon :type="organization.organization_type" class="h-4 w-4 mr-2" />
              ...
              <!-- Description -->
              <div v-if="organization.description" class="mt-6">
                <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-3">
                  {{ $t('organizationDetail.description') }}
                </h3>
                <p class="text-gray-600 dark:text-gray-400 whitespace-pre-wrap">{{ organization.description }}</p>
              </div>

              <!-- Aliases -->
              <div v-if="organization.organization_aliases && organization.organization_aliases.length > 0" class="mt-6">
                <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-3">
                ...
                <div class="flex flex-wrap gap-2">
                  ...
                  >
                    {{ alias.alias_name }}
                    <span v-if="alias.is_acronym" class="ml-1 text-xs">{{ $t('organizationDetail.acronym') }}</span>
                  </span>
                </div>
              </div>
            </div>
