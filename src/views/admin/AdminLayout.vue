    ...
    <main :class="[
      ...
      <header
        :class="[
          ...
          isReviewSidebarOpen && isActivityReviewMode ? '' : ''
        ]"
        :style="isReviewSidebarOpen && isActivityReviewMode ? { marginLeft: reviewSidebarWidth + 'px', transition: 'margin-left 0.3s' } : { transition: 'margin-left 0.3s' }"
      >
