<template>
  <div
    v-if="isVisible"
    :class="[
      'rounded-lg p-4 mb-6 shadow-md transition-all duration-300',
  ...
  >
    <div class="flex items-start gap-3">
      ...
      <button
        v-if="dismissible"
        @click="dismiss"
        class="flex-shrink-0 ml-auto cursor-pointer hover:opacity-75 transition-opacity"
...
const severityClasses = {
  ...
  warning: 'bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 text-orange-800 dark:text-orange-200',
