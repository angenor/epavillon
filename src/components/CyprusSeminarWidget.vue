      ...
      <div class="text-white bg-gradient-to-br from-orange-500/40 via-blue-600/40 to-blue-700/40 backdrop-blur-sm rounded-xl px-4 py-3 hover:from-orange-500/50 hover:via-blue-600/50 hover:to-blue-700/50 transition-all duration-300 shadow-lg border-2 border-orange-400/30 relative overflow-hidden">
        ...
        <div class="relative z-10">
          ...
          <div class="font-bold text-xl mb-2 flex items-center gap-2">
            ...
            <span>Séminaire Finance Durable</span>
          </div>

          <!-- Informations -->
          <div class="space-y-3">
            <!-- Date en évidence avec badge -->
            <div class="relative">
              <div class="inline-flex items-center gap-2 bg-gradient-to-r from-orange-400/30 to-yellow-400/30 backdrop-blur-sm rounded-lg px-3 py-2 border border-orange-300/40 shadow-lg">
                <svg class="w-5 h-5 text-orange-200 flex-shrink-0 animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
                <span class="text-base font-bold text-white drop-shadow-md">1-3 Décembre 2025</span>
              </div>
            </div>
            ...
            <div class="flex items-center gap-2">
              ...
              <span class="text-sm font-medium">Larnaka et Nicosie, Chypre</span>
            </div>
