      ...
      <div class="flex items-center flex-1 min-w-0">
        ...
        <div class="flex-1 min-w-0">
          <div class="flex items-center">
            ...
            <div v-if="organization.is_verified" class="ml-2 flex-shrink-0">
          ...
          <div class="mt-1 flex items-center space-x-4 text-sm text-gray-500 dark:text-gray-400">
            ...
            <div class="flex items-center">
              ...
              <span>{{ organization.countries?.name_fr || $t('organizations.unknownCountry') }}</span>
              <img
                ...
                class="ml-1 h-3 w-5 object-cover border border-gray-200 dark:border-gray-600"
              />
            </div>
            ...
            <div class="flex items-center">
              ...
              <span>{{ $t('organizations.activitiesCount', { count: getActivityCount(organization) }) }}</span>
            </div>
