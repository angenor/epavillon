          ...
          >
            <div class="flex items-start space-x-3">
              ...
              <div class="flex-shrink-0">
                ...
                <!-- Notification de commentaire de révision -->
                <div v-else-if="notification.notification_type === 'revision_comment'" class="w-10 h-10 rounded-full bg-purple-500 flex items-center justify-center">
