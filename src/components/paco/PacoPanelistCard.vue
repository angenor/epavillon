  ...
  <div class="flex items-center gap-3 bg-white/5 border border-white/10 rounded-xl p-3">
    ...
    <div class="min-w-0">
      ...
      <div class="relative group/role block max-w-full">
        ...
        <span
          v-if="roleLabel"
          class="pointer-events-none absolute left-0 bottom-full mb-1 z-20 hidden group-hover/role:block whitespace-normal break-words w-max max-w-xs px-2 py-1 rounded-md bg-gray-900 text-white text-xs shadow-lg border border-white/10"
        >
          {{ roleLabel }}
        </span>
      </div>
