...
const SESSIONS_DATA = [
  ...
  },
  {
    ...
    panelists: [
      ...
      { id: 'tenedja-silue', name: 'Dre Ténédja SILUE', photoUrl: '/images/Tenedja_SILUE.jpeg', organization: "Université Félix Houphouët Boigny d'Abidjan, Côte d'Ivoire", email: null },
